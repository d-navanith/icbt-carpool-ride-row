        ...
        <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/[0.08] bg-gradient-to-b from-white/[0.03] to-transparent">
          ...
          <div className="mt-8 pt-6 border-t border-white/[0.08]">
            ...
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                onClick={() => handleQuickFill('admin@icbt.edu.lk', 'admin123')}
                className="px-2.5 py-1 rounded-lg bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 text-[11px] font-bold border border-purple-500/30 transition"
              >
                Admin
              </button>
              <button
        ...
        <div className="lg:col-span-7 p-8 sm:p-10 flex flex-col justify-center bg-white/[0.02] backdrop-blur-3xl">
          ...
          <div className="max-w-md w-full mx-auto space-y-6">
            ...
            <p className="text-center text-[11px] text-slate-500">
              Admin & security controls are restricted to verified ICBT staff credentials.
            </p>
